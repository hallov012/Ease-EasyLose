...
public interface DailyMealLogService {
    ...
    DailyMealLogDto.ResponseDto createDailyMeal(Long id, DailyMealLogDto.CreateAndUpdateRequestDto createRequestDto);
    DailyMealLogDto.ResponseDto updateDailyMeal(Long id, Long dailyMeal_id, DailyMealLogDto.CreateAndUpdateRequestDto updateRequestDto);
