...
public class DailyMealLogServiceImpl implements DailyMealLogService {
    ...
    @Autowired
    public DailyMealLogServiceImpl(DailyMealLogRepository dailyMealLogRepository, UserRepository userRepository){
    ...
    public DailyMealLogDto.ResponseDto createDailyMeal(Long id, DailyMealLogDto.CreateAndUpdateRequestDto createRequestDto){
        User user = userRepository.findById(id).orElse(null);
    ...
    public DailyMealLogDto.ResponseDto updateDailyMeal(Long id, Long dailyMeal_id, DailyMealLogDto.CreateAndUpdateRequestDto updateRequestDto){
        User user = userRepository.findById(id).orElse(null);
