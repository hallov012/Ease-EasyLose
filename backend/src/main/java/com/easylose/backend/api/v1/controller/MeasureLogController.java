...
public class MeasureLogController {
  ...
  public ResponseEntity<Collection<MeasureLogResponseDto>> getMeasureLogAll(
      @AuthenticationPrincipal Long id,
      @RequestParam(required = false) @DateTimeFormat(pattern = "yyyy-MM-dd") LocalDate start,
      @RequestParam(required = false) @DateTimeFormat(pattern = "yyyy-MM-dd") LocalDate end) {
    Collection<MeasureLogResponseDto> response = measureLogService.getMeasureLogAll(id, start, end);
  ...
  //  public ResponseEntity<Collection> getNutrientLogAll(
  //      @AuthenticationPrincipal Long id,
  //      @RequestParam(required = false) @DateTimeFormat(pattern = "yyyy-MM-dd") LocalDate start,
  //      @RequestParam(required = false) @DateTimeFormat(pattern = "yyyy-MM-dd") LocalDate end) {
  //    Collection response = measureLogService.getNutrientLogAll(id, start, end);
  //    return ResponseEntity.status(HttpStatus.OK).body(response);
  //  }
}
